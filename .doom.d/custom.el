(custom-set-variables
 ...
 '(jdee-db-active-breakpoint-face-colors (cons "#222228" "#e297ac"))
 ...
 '(package-selected-packages
   '(skewer-mode scss-mode prettier-js prettier indium ng2-mode emmet-mode impatient-mode org-pomodoro org-roam-bibtex org-wild-notifier auctex))
 '(pdf-view-midnight-colors (cons "#FFFFFF" "#160f16"))
 '(rustic-ansi-faces
   ["#160f16" "#964C7B" "#74DFC4" "#FFE261" "#a88fa8" "#e297ac" "#B4DCE7" "#FFFFFF"])
 '(vc-annotate-background "#160f16")
