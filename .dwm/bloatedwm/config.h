...
const char *spcmd3[] = {TERMINAL, "--name",           "spmusic",
                        "-e",     "ncmpcpp-ueberzug", NULL};
...
static const Layout layouts[] = {
    ...
    {"[><]", NULL},  /* Decreasing in size right and leftward */
    ...
    {"|||", col},      /* Vertical monitor layout */
    {"++", horizgrid}, /* Same but master floats */

    {"[\\]", dwindle}, /* no layout function means floating behavior */
    {NULL, NULL},
};
...
static Key keys[] = {
    ...
    /*	{ MODKEY,			XK_p,			spawn,
       ...
       XK_backslash,		view,		{0} }, { MODKEY|ShiftMask,
       XK_backslash,		spawn,		SHCMD("") }, */
    ...
    {0, XK_Print, spawn,
     SHCMD(
         ...
         "notify-send -i ~/.config/icon/screenshot.png '  Screenshot Taken'")},
    {MODKEY, XK_Print, spawn,
     SHCMD(
         "maim -u -s ~/Pictures/Screenshots/$(date '+%y-%m-%d_%H:%M:%S').png; "
         "notify-send -i ~/.config/icon/screenshot.png '  Screenshot Taken'")},
    {ShiftMask, XK_Print, spawn,
     SHCMD("maimpick; notify-send -i ~/.config/icon/screenshot.png '  "
           "Screenshot Taken'")},
    ...
    {0, XF86XK_AudioRaiseVolume, spawn,
     SHCMD("pactl -- set-sink-volume @DEFAULT_SINK@ +5%; kill -44 $(pidof "
           "dwmblocks)")},
