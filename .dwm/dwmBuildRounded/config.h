...
static unsigned int cornerrad = 15; 
static int swallowfloating    = 0;        /* 1 means swallow floating windows by default */
static int smartgaps          = 0;        /* 1 means no outer gap when there is only one window */
static int showbar            = 1;        /* 0 means no bar */
static int topbar             = 1;        /* 0 means bottom bar */
static char *fonts[]          = { "Mononoki Nerd Font:size=10:antialias=true:autohint=true",
...
static const Rule rules[] = {
	...
	*/
	...
	{ NULL,      "spkitty",    NULL,       	    SPTAG(1),     1,           1,         0,        -1 },
};
...
/*	 { MODKEY|ShiftMask,		XK_grave,	togglescratch,	SHCMD("scratchpadcmd") },*/ 
	TAGKEYS(			XK_1,		0)
	TAGKEYS(			XK_2,		1)
	TAGKEYS(			XK_3,		2)
	TAGKEYS(			XK_4,		3)
	...
	{ MODKEY,			XK_e,		spawn,		SHCMD("kitty zsh -ic ranger") },
	{ MODKEY|ShiftMask,		XK_e,		spawn,		SHCMD("pcmanfm") },
	{ MODKEY,			XK_r,		spawn,		SHCMD(TERMINAL "zsh -ic bpytop") },
	{ MODKEY|ShiftMask,		XK_r,		spawn,		SHCMD(TERMINAL "zsh -ic htop") },
